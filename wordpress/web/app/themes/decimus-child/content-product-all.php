    ...
    <div class="card">
        <div <?php wc_product_class( '', $product ); ?>>
            ...
            <div class="bg-white card-body">
				<?php
				$html = '<h2 class="h3 bold-500 card-title ' . esc_attr( apply_filters( 'woocommerce_product_loop_title_classes',
						'woocommerce-loop-product__title' ) ) . '" style="margin-bottom: 10px;">';
				$html .= '<a href="' . esc_url( $link ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">';
