...
if ( ! function_exists( 'decimus_category_badge' ) ) :
	 ...
	 * @return void
	 */
	function decimus_category_badge(): void {
...
if ( ! function_exists( 'decimus_tags' ) ) :
	...
	if ( ! function_exists( 'decimus_add_tag_class' ) ) :
...
if ( ! function_exists( 'decimus_post_thumbnail' ) ) :
	 ...
	 * @return void
	 */
	function decimus_post_thumbnail(): void {
...
if ( ! function_exists( 'decimus_ie_alert' ) ) :
	...
	function decimus_ie_alert(): void {
		...
		if ( preg_match( '~MSIE|Internet Explorer~i', $ua ) || ( strpos( $ua, 'Trident/7.0' ) !== false && strpos( $ua,
					'rv:11.0' ) !== false ) ) {
			echo '
                    <div class="container pt-5">
                        <div class="alert alert-warning alert-dismissible fade show mt-4" role="alert">
                            <h1>' . esc_html__( 'Internet Explorer detected', 'decimus' ) . '</h1>
                            <p class="lead">' . esc_html__( 'This website will offer limited functionality in this browser.',
					'decimus' ) . '</p>
                            <p class="lead">' . esc_html__( 'Please use a modern and secure web browser like',
					'decimus' ) . ' <a href="https://www.mozilla.org/firefox/" target="_blank">Mozilla Firefox</a>, <a href="https://www.google.com/chrome/" target="_blank">Google Chrome</a>, <a href="https://www.opera.com/" target="_blank">Opera</a> ' . esc_html__( 'or',
					'decimus' ) . ' <a href="https://www.microsoft.com/edge" target="_blank">Microsoft Edge</a> ' . esc_html__( 'to display this site correctly.',
					'decimus' ) . '</p>
                        </div>
                    </div>
               ';
