	...
	function decimus_comment( $comment, $args, $depth ): void {
		...
		if ( 'pingback' == $comment->comment_type || 'trackback' == $comment->comment_type ) : ?>
            ...
            <div class="comment-body">
				<?php _e( 'Pingback:', 'decimus' ); ?><?php comment_author_link(); ?><?php edit_comment_link(
					__( 'Edit', 'decimus' ),
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-0">
									<?php if ( 0 != $args['avatar_size'] ) {
										echo get_avatar(
											...
											'',
											'',
											array( 'class' => 'img-thumbnail rounded-circle' )
										);
									} ?>
									<?php printf(
										__( '%s <span class="says d-none">says:</span>', 'decimus' ),
										sprintf( '<h3 class="h5">%s</h3>', get_comment_author_link() )
									); ?>
                                </div>
                                ...
                                <div class="small comment-meta text-muted mb-2">
                                    <time datetime="<?php comment_time( 'c' ); ?>">
										<?php printf(
											_x( '%1$s at %2$s', '1: date, 2: time', 'decimus' ),
											get_comment_date(),
											get_comment_time()
										); ?>
                                    </time>
...
if ( ! function_exists( 'decimus_custom_reply_title' ) ) :
	/**
	 * h2 Reply Title
	 *
...
if ( ! function_exists( 'decimus_change_comment_form_cookies_consent' ) ) :
...
if ( ! function_exists( 'decimus_open_comment_author_link_in_new_window' ) ) :
...
if ( ! function_exists( 'decimus_comment_links_in_new_tab' ) ) :
	...
	/**
	 * Open links in comments in new tab filter callback
	 *
	 * @param $text
	 *
	 * @return string
...
if ( ! function_exists( 'decimus_comment_form' ) ) :
