...
if ( ! class_exists( 'Decimus_taxonomy_image' ) ) {
	...
	final class Decimus_taxonomy_image {
		...
		private const TAXONOMY_IMAGE_OPTIONS = 'decimus_taxonomy_image_options';
		...
		private function __construct() {
			...
			if ( is_admin() ) {
				$this->options = get_option( self::TAXONOMY_IMAGE_OPTIONS );
		...
		public function register_settings(): void {
			register_setting( self::TAXONOMY_IMAGE_OPTIONS, self::TAXONOMY_IMAGE_OPTIONS,
		...
		public function checked_taxonomies(): void {
			$options             = get_option( self::TAXONOMY_IMAGE_OPTIONS );
			...
			foreach ( get_taxonomies() as $tax ) {
                ...
                <input type="checkbox"
                       name="<?php echo self::TAXONOMY_IMAGE_OPTIONS ?>[checked_taxonomies][<?php echo $tax ?>]"
		...
		public function options(): void {
            ...
            <div class="wrap">
                ...
                <form method="post" action="options.php">
					<?php settings_fields( self::TAXONOMY_IMAGE_OPTIONS ); ?>
		...
		public static function delete_plugin(): void {
			delete_option( self::TAXONOMY_IMAGE_OPTIONS );
		}
	}
}
